...
- [ ] `README.md` §2.2 passa a dizer que uma entidade só precisa de arquivo em
...
- [ ] O ADR cita o caso `stock_applied` (`OrderItem` do `meu-negocio-app`)
