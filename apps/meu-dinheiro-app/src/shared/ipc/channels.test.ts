...
describe('shouldNotifyDataChanged', () => {
  ...
  it('avisa nas escritas', () => {
    const writes = [
      ...
      IPC_CHANNELS.monthsCreate,
      IPC_CHANNELS.monthsCreateBatch,
      IPC_CHANNELS.monthsDelete,
      IPC_CHANNELS.expensesCreate,
      IPC_CHANNELS.expensesUpdate,
      IPC_CHANNELS.expensesDelete,
      IPC_CHANNELS.expensesPay,
      IPC_CHANNELS.expensesUnpay,
      IPC_CHANNELS.incomesCreate,
      IPC_CHANNELS.incomesReceive,
      IPC_CHANNELS.incomesUnreceive,
      IPC_CHANNELS.bankAccountsCreate,
      IPC_CHANNELS.bankAccountsDelete,
      IPC_CHANNELS.categoriesCreate,
      IPC_CHANNELS.categoriesDelete,
      IPC_CHANNELS.defaultExpensesCreate,
      IPC_CHANNELS.defaultIncomesCreate,
